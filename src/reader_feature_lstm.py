...
class Reader:
    ...
    def __init__(self, config):
        ...
        sky_cam_train_raw_data = np.load('automatic_cloud_X_train.npy')
        sky_cam_validation_raw_data = np.load('automatic_cloud_X_validation.npy')
        sky_cam_test_raw_data = np.load('automatic_cloud_X_test.npy')

        print 'Train Data Shape:', sky_cam_train_raw_data.shape
        print 'Validation Data Shape:', sky_cam_validation_raw_data.shape
        print 'Test Data Shape:', sky_cam_test_raw_data.shape
        ...
        print 'Target Train Data Shape:', target_train_raw_data.shape
        print 'Target Validation Data Shape:', target_validation_raw_data.shape
        print 'Target Test Data Shape:', target_test_raw_data.shape
        #feature eshape
    ...
    def get_validation_set(self):
        ...
        return self.sky_cam_validation_data[index], self.target_validation_data[index]
    ...
    def get_test_set(self, test_num):
        ...
        return self.sky_cam_test_data[index], self.target_test_data[index]
