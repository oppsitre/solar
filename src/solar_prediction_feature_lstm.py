...
from reader_feature_lstm import Reader
from model_lstm_16 import Model
...
def main(_):
    ...
    x_sky_cam = tf.placeholder(tf.float32, [None, n_step, 16])
    ...
    with tf.Session() as sess:
        ...
        #sess.run(init_op)
        save_path = './feature_lstm_model.ckpt'
